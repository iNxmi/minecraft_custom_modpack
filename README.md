...
* [Paxi](https://modrinth.com/mod/paxi) is interfering with [Resource Pack Overrides](https://modrinth.com/mod/resource-pack-overrides) -> add default [config/paxi/resourcepack_load_order.json](configureddefaults/config/paxi/resourcepack_load_order.json)
